@TestCase
Feature: NDC-Price-OneWay_ADTCHDINF

  @ScenarioCreation1G
  Scenario Outline: Pricing Comparision OneWay 2-ADT And 2-CHD And 1-INF for Gen-1 and Gen-3
    ...
    Then Validate and Compare the responses for "Price" for both Versions
	 ...
	 Examples: 
      ...
      | FR          | PAR      | 2026159  | CDG         | JFK       |       30 | MEX         | AMS       |       35 | AF         | AF               | EUR          | 680I           | zu2-dv       |
