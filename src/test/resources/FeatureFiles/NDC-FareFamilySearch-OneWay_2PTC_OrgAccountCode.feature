...
Feature: NDC-FareFamilySearch-OneWay_2PTC  
  ...
  Scenario Outline: FareFamilySearch OneWay 2-PTC for Gen-1 and Gen-3 responses
    ...
    And with OrganizationInformation accountcode 'A8JWY' is added to Search
    And Ignore below keywords or values while comparing Gen-1 and Gen-3 responses
    #| IgnoreDecimalZero |
     | BrandRef 				 |
     | id                |
     | FlightRef         |
    When Invoke the Search request 'Search_FareFamily_OneWay_2PTC_OrganizationAccountCode' with endpoint 'NDC-Search' Request for 'GEN-1' Version
    #When Execute the 'Search_FareFamily_NextLeg' with endpoint 'NDC-Search-NextLeg' Request for 'GEN-1' Version
    When Invoke the Search request 'Search_FareFamily_OneWay_2PTC_OrganizationAccountCode' with endpoint 'NDC-Search' Request for 'GEN-3' Version
