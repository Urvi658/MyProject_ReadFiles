@TestCase
Feature: FFS-RoundTrip_2PTC_CabinPreference  

  @ScenarioCreation1G @SkipTest
  Scenario Outline: FareFamilySearch RoundTrip 2-PTC for Gen-1 and Gen-3 responses
    ...
    #| IgnoreDecimalZero |
     ...
     | id                |
     | FlightRef         |
    When Invoke the Search request 'FFS_RoundTrip_2PTC_CabinPreference' with endpoint 'NDC-Search' Request for 'GEN-1' Version
    #When Execute the 'Search_FareFamily_NextLeg' with endpoint 'NDC-Search-NextLeg' Request for 'GEN-1' Version
    When Invoke the Search request 'FFS_RoundTrip_2PTC_CabinPreference' with endpoint 'NDC-Search' Request for 'GEN-3' Version
