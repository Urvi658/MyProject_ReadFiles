...
public class TestObjectProperty {
    ...
    public TestObjectProperty(String name, String condition, String value) {
        this.name = name;
    ...
    public TestObjectProperty(String name, String condition, String value, boolean isActive) {
        this.name = name;
        this.condition = condition;
        this.value = value;
