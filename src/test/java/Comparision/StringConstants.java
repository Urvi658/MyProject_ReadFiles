...
public class StringConstants {
    ...
    public static final String LOG_START_CASE_BINDING = "Start Test Case Binding";

    public static final String LOG_START_SUITE_METHOD = "startSuite";

    public static final String LOG_START_TEST_CASE_BINDING_METHOD = "startTestCaseBinding";
    ...
    public static final String LOG_END_CASE_BINDING = "End Test Case Binding";
    public static final String LOG_END_SUITE_METHOD = "endSuite";

    public static final String LOG_END_TEST_CASE_BINDING_METHOD = "endTestCaseBinding";
    ...
    public static final String XML_LOG_ITERATION_PROPERTY = "iteration";
...
//    public static final String INTERNAL_GLOBAL_VARIABLE_FILE_NAME = GENERATED_SCRIPT_FOLDER + File.separator + "internal" + File.separator + "GlobalVariable." + SCRIPT_FILE_EXT;
    ...
    public static final String CONF_PROPERTY_REMOTE_DRIVER = "Remote";
...
//    public static final String APP_INFO_FILE_LOCATION = System.getProperty("user.home") + File.separator + ".katalon" + File.separator + "application.properties"; //$NON-NLS-1$
    ...
    public static final String EXC_MSG_EXCEL_CANNOT_FIND_SHEET = CoreMessageConstants.EXC_MSG_EXCEL_CANNOT_FIND_SHEET;
    ...
    public static final String EXCUTION_KEYWORDS_USAGE = "keywordsUsage";

    public static final String EXECUTION_BINDING_VARIABLES = "executionBindingVariables";
